...
public class exponent {
    public static void main(String[] args) {
        System.out.println("2 raised to the power 3 is " + Math.pow(2, 3)); //power
        System.out.println("Exponent squared is " + Math.exp(2)); //
        System.out.println("The square root of 16 is " + Math.sqrt(16)); //square root
        System.out.println("The cube root of 27 is " + Math.cbrt(27)); //cube root
